...
const UserCard = ({ user, displayName, onLogout, onNavigate }) => (
  <div className="rounded-2xl border border-ink-700/60 bg-ink-850/60 p-3">
    ...
    <button
      type="button"
      onClick={onLogout}
      className="mt-3 w-full rounded-lg border border-ink-600/70 px-3 py-2 text-xs font-medium text-mist-muted transition hover:border-red-300 hover:text-red-600"
    >
      Sign out
    </button>
  </div>
