...
export function CloudgateAbout({ appName = manifest?.name, appVersion = manifest?.version, description = manifest?.description, showTitle = true }) {
    ...
    <div className="cg-about">
      ...
      <section className="cg-about-card">
        ...
        <ul className="cg-about-facts">
          <li><Boxes size={15} /><span><strong>Workflows.</strong> Application data and saved settings are served by published workflow actions under this app's controller. The Logs page shows recorded calls.</span></li>
